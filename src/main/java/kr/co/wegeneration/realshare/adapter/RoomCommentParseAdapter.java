 ...
 */
public class RoomCommentParseAdapter extends ParseQueryAdapter<RoomComment> {

    private AssetManager asset;
    ImageLoader imageLoader = MyApplication.getInstance().getImageLoader();

    public RoomCommentParseAdapter(Context context, QueryFactory<RoomComment> queryfactory) {
        super(context, queryfactory);
    }

    public RoomCommentParseAdapter(Context context, AssetManager asset, final String roomId) {
    ...
    @Override
    public View getItemView(final RoomComment commentLog, View view, ViewGroup parent) {
        ...
        try {
            ...
            holder.comment.setText(commentLog.getContent());
            holder.username.setText(commentLog.getUserNm());
            ...
            if (commentLog.getUserId().equals(ParseUser.getCurrentUser().getObjectId())) {
            ...
            holder.commentDel.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ParseNetController.RoomComment(getContext(), param, commentLog);
