...
public abstract class VideoStream extends MediaStream {
	...
	protected VideoQuality mRequestedQuality = VideoQuality.SD_VIDEO_QUALITY.clone();
	...
	public synchronized void configure() throws IllegalStateException, IOException {
        ...
        mQuality = mRequestedQuality; // dpmin : 추가
	}
	...
	protected void encodeWithMediaRecorder() throws IOException, ConfNotSupportedException {
		...
		try {
			...
			mMediaRecorder.setVideoFrameRate((int)mRequestedQuality.framerate);
	...
	protected void encodeWithMediaCodecMethod1() throws RuntimeException, IOException {
		...
		mediaFormat.setFloat(MediaFormat.KEY_FRAME_RATE, mQuality.framerate);
	...
	private void measureFramerate() {
		...
		final Camera.PreviewCallback callback = new Camera.PreviewCallback() {
			...
			public void onPreviewFrame(byte[] data, Camera camera) {
				...
				if (i>20) {
					mQuality.framerate = (float) (1000000/(t/count)+1);
					lock.release();
				}
				oldnow = now;
			}
		...
		try {
			...
			if (mSettings != null) {
				...
				editor.putFloat(PREF_PREFIX + "fps" + mRequestedQuality.framerate + "," + mCameraImageFormat + "," + mRequestedQuality.resX + mRequestedQuality.resY, mQuality.framerate);
				editor.commit();
			}
