...
public class VideoQuality {
    ...
    public final static VideoQuality SD_VIDEO_QUALITY = new VideoQuality(480,360,20,1500000);
    public final static VideoQuality HD_VIDEO_QUALITY = new VideoQuality(1280,720,20,3000000);
    public final static VideoQuality FHD_VIDEO_QUALITY = new VideoQuality(1920,1080,20,5000000);
	 ...
	 */
	public VideoQuality(int resX, int resY, float framerate, int bitrate) {
